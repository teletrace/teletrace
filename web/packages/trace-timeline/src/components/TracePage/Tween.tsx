...
export default class Tween {
  ...
  // ** CHANGED - tween-functions package does not contain types - function has been copied from tween-functions source code **
  _easeOutQuint = (t: number, b: number, _c: number, d: number) => {
    var c = _c - b;
  ...
  getCurrent(): ITweenState {
    ...
    return {
      ...
      value: this._easeOutQuint(t, this.from, this.to, this.duration),
    };
  }
}
