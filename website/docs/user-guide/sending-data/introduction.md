Teletrace is leveraging [OpenTelemetry](https://opentelemetry.io/) as an open-source standard for collecting high-quality, ubiquitous telemetry data from microservice applications.
